...
.PHONY: midres.embedded.atari
midres.embedded.atari:
	$(FILE2INCLUDE) -i $(DATADIR)/slideshowa.dat -n slideshow -i $(DATADIR)/imagea01.pic -n imagea01.mpic -i $(DATADIR)/imagea02.pic -n imagea02.mpic -i $(DATADIR)/imagea03.pic -n imagea03.mpic -i $(DATADIR)/imagea04.pic -n imagea04.mpic -i $(DATADIR)/ztiles.bin -n ztiles.bin -i $(DATADIR)/tiles.bin -n tiles.bin -i $(DATADIR)/tutorial_mctile.bin -n mctile.bin -i $(DATADIR)/testcard.bin -n testcard.bin -i $(DATADIR)/zdjtiles.bin -n zdjtiles.bin -i $(DATADIR)/zeltiles.bin -n zeltiles.bin -i $(DATADIR)/toccatina.imf -n toccatina.imf -i $(DATADIR)/alice.imf -n alice.imf -i $(DATADIR)/island.imf -n island.imf -c src/rawdata.c -h src/rawdata.h
...
.PHONY: midres.embedded.c128
midres.embedded.c128:
	$(FILE2INCLUDE) -i $(DATADIR)/slideshow64.dat -n slideshow -i $(DATADIR)/image6401.mpic -n image6401.mpic -i $(DATADIR)/image6402.mpic -n image6402.mpic -i $(DATADIR)/image6403.mpic -n image6403.mpic -i $(DATADIR)/image6404.mpic -n image6404.mpic -i $(DATADIR)/tiles.bin -n tiles.bin -i $(DATADIR)/aatiles.bin -n aatiles.bin -i $(DATADIR)/aaintro64.mpic -n aaintro.mpic -i $(DATADIR)/tutorial_mctile.bin -n mctile.bin -i $(DATADIR)/testcard.bin -n testcard.bin -i $(DATADIR)/zdjtiles.bin -n zdjtiles.bin -i $(DATADIR)/zeltiles.bin -n zeltiles.bin -i $(DATADIR)/toccatina.imf -n toccatina.imf -i $(DATADIR)/alice.imf -n alice.imf -i $(DATADIR)/island.imf -n island.imf -c src/rawdata.c -h src/rawdata.h
...
.PHONY: midres.embedded.c16
midres.embedded.c16:
	$(FILE2INCLUDE) -i $(DATADIR)/slideshow16.dat -n slideshow -i $(DATADIR)/image1601.mpic -n image1601.mpic -i $(DATADIR)/image1602.mpic -n image1602.mpic -i $(DATADIR)/image1603.mpic -n image1603.mpic -i $(DATADIR)/image1604.mpic -n image1604.mpic -i $(DATADIR)/tiles.bin -n tiles.bin -i $(DATADIR)/aatiles4.bin -n aatiles.bin -i $(DATADIR)/aaintro16.mpic -n aaintro.mpic -i $(DATADIR)/tutorial_mctile.bin -n mctile.bin -i $(DATADIR)/testcard.bin -n testcard.bin -i $(DATADIR)/zdjtiles.bin -n zdjtiles.bin -i $(DATADIR)/zeltiles.bin -n zeltiles.bin -i $(DATADIR)/toccatina.imf -n toccatina.imf -i $(DATADIR)/alice.imf -n alice.imf -i $(DATADIR)/island.imf -n island.imf -c src/rawdata.c -h src/rawdata.h
...
.PHONY: midres.embedded.coleco
midres.embedded.coleco:
	$(FILE2INCLUDE) -i $(DATADIR)/mtiles.bin -n mtiles.bin -i $(DATADIR)/tiles.bin -n tiles.bin -i $(DATADIR)/tutorial_mctile.bin -n tutorial_mctile.bin -i $(DATADIR)/zeltiles.bin -n zeltiles.bin -i $(DATADIR)/toccatina.imf -n toccatina.imf -i $(DATADIR)/alice.imf -n alice.imf -i $(DATADIR)/island.imf -n island.imf -c src/rawdata.c -h src/rawdata.h
...
.PHONY: midres.embedded.vic20
midres.embedded.vic20:
	$(FILE2INCLUDE) -i $(DATADIR)/slideshow20.dat -n slideshow -i $(DATADIR)/image2001.mpic -n image2001.mpic -i $(DATADIR)/image2002.mpic -n image2002.mpic -i $(DATADIR)/image2003.mpic -n image2003.mpic -i $(DATADIR)/image2004.mpic -n image2004.mpic -i $(DATADIR)/tiles.bin -n tiles.bin -i $(DATADIR)/aatiles20.bin -n aatiles.bin -i $(DATADIR)/aaintro20.mpic -n aaintro.mpic -i $(DATADIR)/tutorial_mctile.bin -n mctile.bin -i $(DATADIR)/testcard.bin -n testcard.bin -i $(DATADIR)/zdjtiles.bin -n zdjtiles.bin -i $(DATADIR)/zeltiles.bin -n zeltiles.bin -i $(DATADIR)/toccatina.imf -n toccatina.imf -i $(DATADIR)/alice.imf -n alice.imf -i $(DATADIR)/island.imf -n island.imf -c src/rawdata.c -h src/rawdata.h
...
#!!! missing resources for musician (atari)
...
#!!! missing resources for musician (c128)
...
#!!! missing resources for musician (c16)
...
#!!! missing resources for musician (c64)
...
#!!! missing resources for musician (coleco)
...
#!!! missing resources for musician (gb)
...
#!!! missing resources for musician (lm80c)
...
#!!! missing resources for musician (msx)
...
#!!! missing resources for musician (mtx500)
...
#!!! missing resources for musician (plus4)
...
#!!! missing resources for musician (svi)
...
#!!! missing resources for musician (vic20)
...
#!!! missing resources for musician (vic2024)
