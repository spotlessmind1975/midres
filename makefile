...
$(EXEDIR)/benchmarks.atari: benchmarks.embedded.atari  $(subst PLATFORM,benchmarks.atari,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.atari,$(OBJS))
	$(CC) -Ln demoatari.lbl -t atari -C cfg/atari.cfg $(LDFLAGS) -m $(EXEDIR)/benchmarks.atari.map -o $(EXEDIR)/benchmarks.atari  $(subst PLATFORM,benchmarks.atari,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.atari,$(OBJS)) $(LIBDIR)/midres.atari.lib
	$(call RMFILES,$(EXEDIR)/atr/*.*)
	$(call COPYFILES,$(DIR2ATR_HOME)/dos25/dos.sys,$(EXEDIR)/atr/dos.sys)
...
$(EXEDIR)/benchmarks.c128: benchmarks.embedded.c128  $(subst PLATFORM,benchmarks.c128,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.c128,$(OBJS))
	$(CC) -Ln democ128.lbl -t c128 -C cfg/c128.cfg $(LDFLAGS) -m $(EXEDIR)/benchmarks.c128.map -o $(EXEDIR)/benchmarks.c128  $(subst PLATFORM,benchmarks.c128,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.c128,$(OBJS)) $(LIBDIR)/midres.c128.lib
...
$(EXEDIR)/benchmarks.c16: benchmarks.embedded.c16  $(subst PLATFORM,benchmarks.c16,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.c16,$(OBJS))
	$(CC) -Ln democ16.lbl -t c16 -C cfg/c16.cfg $(LDFLAGS) -m $(EXEDIR)/benchmarks.c16.map -o $(EXEDIR)/benchmarks.c16  $(subst PLATFORM,benchmarks.c16,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.c16,$(OBJS)) $(LIBDIR)/midres.c16.lib
...
$(EXEDIR)/benchmarks.c64: benchmarks.embedded.c64  $(subst PLATFORM,benchmarks.c64,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.c64,$(OBJS))
	$(CC) -Ln democ64.lbl -t c64 -C cfg/c64.cfg $(LDFLAGS) -m $(EXEDIR)/benchmarks.c64.map -o $(EXEDIR)/benchmarks.c64  $(subst PLATFORM,benchmarks.c64,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.c64,$(OBJS)) $(LIBDIR)/midres.c64.lib
...
$(EXEDIR)/benchmarks.plus4: benchmarks.embedded.plus4  $(subst PLATFORM,benchmarks.plus4,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.plus4,$(OBJS))
	$(CC) -Ln demoplus4.lbl -t plus4 -C cfg/plus4.cfg $(LDFLAGS) -m $(EXEDIR)/benchmarks.plus4.map -o $(EXEDIR)/benchmarks.plus4  $(subst PLATFORM,benchmarks.plus4,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.plus4,$(OBJS)) $(LIBDIR)/midres.plus4.lib
...
$(EXEDIR)/benchmarks.vic2024: benchmarks.embedded.vic2024  $(subst PLATFORM,benchmarks.vic2024,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.vic2024,$(OBJS))
	$(CC) -Ln demovic20.lbl -t vic20 -C cfg/vic2024.cfg $(LDFLAGS) -m $(EXEDIR)/benchmarks.vic20.map -o $(EXEDIR)/benchmarks.vic2024  $(subst PLATFORM,benchmarks.vic2024,$(LIB_OBJS)) $(subst PLATFORM,benchmarks.vic2024,$(OBJS)) $(LIBDIR)/midres.vic2024.lib
