...
.PHONY: midres.MSC1.embedded.vic20 midres.MSC1.vic20
midres.MSC1.embedded.vic20:
	$(FILE2INCLUDE) -i $(DATADIR)/slideshow20.dat -n slideshow -i $(DATADIR)/image2001.mpic -n image2001.mpic -i $(DATADIR)/image2002.mpic -n image2002.mpic -i $(DATADIR)/image2003.mpic -n image2003.mpic -i $(DATADIR)/image2004.mpic -n image2004.mpic -i $(DATADIR)/aaintro20.msc1 -n zzintro.ms1 -i $(DATADIR)/tiles.bin -n tiles.bin -i $(DATADIR)/aatiles20.bin -n aatiles.bin -i $(DATADIR)/aaintro20.mpic -n aaintro.mpic -i $(DATADIR)/tutorial_mctile.bin -n mctile.bin -i $(DATADIR)/testcard.bin -n testcard.bin -i $(DATADIR)/zdjtiles.bin -n zdjtiles.bin -i $(DATADIR)/zeltiles.bin -n zeltiles.bin -i $(DATADIR)/toccatina.imf -n toccatina.imf -i $(DATADIR)/alice.imf -n alice.imf -i $(DATADIR)/island.imf -n island.imf -i $(DATADIR)/tetris.imf -n tetris.imf -c src/rawdata.c -h src/rawdata.h


obj/vic20/%.o:	$(SOURCES)
	$(CC) -T -l $(@:.o=.asm) -t vic20 -c $(CFLAGS)  -Osir -Cl -D__CBM__ -o $@ $(subst obj/vic20/,src/,$(@:.o=.c))

$(EXEDIR)/midres.MSC1.vic20: midres.MSC1.embedded.vic20 $(subst PLATFORM,vic20,$(OBJS))
	...
	$(CC1541) -f zzintro.ms1 -w $(DATADIR)/aaintro20.msc1 $(EXEDIR)/midres.vic20.d64 
	...
	$(CC1541) -f zzintro.ms1 -w $(DATADIR)/aaintro20.msc1 $(EXEDIR)/midres.vic20.d71 
	...
	$(CC1541) -f zzintro.ms1 -w $(DATADIR)/aaintro20.msc1 $(EXEDIR)/midres.vic20.d81 
...
obj/vic2024/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/vic2024/midres_atari_impl.o src/midres_atari_impl.asm

obj/vic2024/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/vic2024/midres_c64_impl.o src/midres_c64_impl.asm
...
.PHONY: midres.MSC1.embedded.vic2024 midres.MSC1.vic2024
midres.MSC1.embedded.vic2024:
...
$(EXEDIR)/midres.MSC1.vic2024: midres.MSC1.embedded.vic2024 $(subst PLATFORM,vic2024,$(OBJS))
	...
	$(CC1541) -f zzintro.ms1 -w $(DATADIR)/aaintro20.msc1 $(EXEDIR)/midres.vic2024.d64 
	...
	$(CC1541) -f zzintro.ms1 -w $(DATADIR)/aaintro20.msc1 $(EXEDIR)/midres.vic2024.d71 
	...
	$(CC1541) -f zzintro.ms1 -w $(DATADIR)/aaintro20.msc1 $(EXEDIR)/midres.vic2024.d81 
...
obj/airattack_intro.atari/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t atari -oobj/airattack_intro.atari/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_intro.atari/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t atari -oobj/airattack_intro.atari/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_ending.atari/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t atari -oobj/airattack_ending.atari/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_ending.atari/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t atari -oobj/airattack_ending.atari/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/elevator_ending.atari/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t atari -oobj/elevator_ending.atari/midres_atari_impl.o src/midres_atari_impl.asm

obj/elevator_ending.atari/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t atari -oobj/elevator_ending.atari/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_intro.c128/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c128 -oobj/airattack_intro.c128/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_intro.c128/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c128 -oobj/airattack_intro.c128/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_ending.c128/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c128 -oobj/airattack_ending.c128/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_ending.c128/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c128 -oobj/airattack_ending.c128/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_intro.c128/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c128 -oobj/totto_intro.c128/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_intro.c128/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c128 -oobj/totto_intro.c128/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_ending.c128/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c128 -oobj/totto_ending.c128/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_ending.c128/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c128 -oobj/totto_ending.c128/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_intro.c16/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c16 -oobj/airattack_intro.c16/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_intro.c16/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c16 -oobj/airattack_intro.c16/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_ending.c16/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c16 -oobj/airattack_ending.c16/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_ending.c16/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c16 -oobj/airattack_ending.c16/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_intro.c16/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c16 -oobj/totto_intro.c16/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_intro.c16/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c16 -oobj/totto_intro.c16/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_ending.c16/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c16 -oobj/totto_ending.c16/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_ending.c16/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c16 -oobj/totto_ending.c16/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_intro.c64/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c64 -oobj/airattack_intro.c64/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_intro.c64/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c64 -oobj/airattack_intro.c64/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_ending.c64/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c64 -oobj/airattack_ending.c64/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_ending.c64/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c64 -oobj/airattack_ending.c64/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_intro.c64/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c64 -oobj/totto_intro.c64/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_intro.c64/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c64 -oobj/totto_intro.c64/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_ending.c64/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c64 -oobj/totto_ending.c64/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_ending.c64/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c64 -oobj/totto_ending.c64/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/elevator_ending.c64/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t c64 -oobj/elevator_ending.c64/midres_atari_impl.o src/midres_atari_impl.asm

obj/elevator_ending.c64/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t c64 -oobj/elevator_ending.c64/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_intro.plus4/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t plus4 -oobj/airattack_intro.plus4/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_intro.plus4/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t plus4 -oobj/airattack_intro.plus4/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_ending.plus4/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t plus4 -oobj/airattack_ending.plus4/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_ending.plus4/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t plus4 -oobj/airattack_ending.plus4/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_intro.plus4/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t plus4 -oobj/totto_intro.plus4/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_intro.plus4/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t plus4 -oobj/totto_intro.plus4/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_ending.plus4/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t plus4 -oobj/totto_ending.plus4/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_ending.plus4/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t plus4 -oobj/totto_ending.plus4/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/elevator_ending.plus4/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t plus4 -oobj/elevator_ending.plus4/midres_atari_impl.o src/midres_atari_impl.asm

obj/elevator_ending.plus4/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t plus4 -oobj/elevator_ending.plus4/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_intro.vic20/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/airattack_intro.vic20/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_intro.vic20/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/airattack_intro.vic20/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_ending.vic20/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/airattack_ending.vic20/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_ending.vic20/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/airattack_ending.vic20/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_intro.vic20/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/totto_intro.vic20/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_intro.vic20/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/totto_intro.vic20/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_ending.vic20/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/totto_ending.vic20/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_ending.vic20/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/totto_ending.vic20/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_intro.vic2024/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/airattack_intro.vic2024/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_intro.vic2024/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/airattack_intro.vic2024/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/airattack_ending.vic2024/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/airattack_ending.vic2024/midres_atari_impl.o src/midres_atari_impl.asm

obj/airattack_ending.vic2024/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/airattack_ending.vic2024/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_intro.vic2024/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/totto_intro.vic2024/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_intro.vic2024/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/totto_intro.vic2024/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/totto_ending.vic2024/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/totto_ending.vic2024/midres_atari_impl.o src/midres_atari_impl.asm

obj/totto_ending.vic2024/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/totto_ending.vic2024/midres_c64_impl.o src/midres_c64_impl.asm
...
obj/elevator_ending.vic2024/midres_atari_impl.o:	src/midres_atari_impl.asm
	$(ASM) -t vic20 -oobj/elevator_ending.vic2024/midres_atari_impl.o src/midres_atari_impl.asm

obj/elevator_ending.vic2024/midres_c64_impl.o:	src/midres_c64_impl.asm
	$(ASM) -t vic20 -oobj/elevator_ending.vic2024/midres_c64_impl.o src/midres_c64_impl.asm
