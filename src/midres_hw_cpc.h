...
#ifndef _MIDRES_HW_CPC_H_
#define _MIDRES_HW_CPC_H_

#define MR_SCREEN_WIDTH				80
#define MR_SCREEN_HEIGHT			25
#define MR_SCREEN_RAM_SIZE			0x0800
...
#define MR_SM(_screen)						((mr_mixel*)(0xc000+(0x0*(_screen))))
#define MR_CM(_screen)						((mr_mixel*)(0xc000+(0x0*(_screen))))
#define MR_AM(_screen)						((mr_mixel*)(0xc000+(0x0*(_screen))))
#define MR_TM(_tileset)						((mr_mixel*)(0xc000+(0x0*(_screen))))
